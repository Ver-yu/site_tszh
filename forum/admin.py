...
class PostAdmin(admin.ModelAdmin):
    list_display = ('title', 'author_link', 'created_at', 'has_poll')  # Исправлено на created_at
    list_filter = ('created_at', 'author__role')
    search_fields = ('title', 'content')
    readonly_fields = ('preview_image',)
    date_hierarchy = 'created_at'  # Добавлена иерархия по дате
...
class PollAdmin(admin.ModelAdmin):
    list_display = ('question', 'post_link', 'total_votes')
